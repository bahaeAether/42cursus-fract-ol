...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/30 19:56:25 by baboulou          #+#    #+#             */
/*   Updated: 2023/05/30 23:06:08 by baboulou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_man(void)
{
	ft_putstr("Usage: ./fractol_bonus [-fractal]\n");
	ft_putstr("Available fractals: mandelbrot, julia, burning_ship\n");
	exit(1);
}
...
void	parse_args_julia(int ac, char **av, t_fractol *fractal)
{
	if (ac != 4 && ac != 2)
	{
		ft_putstr("Usage: ./fractol_bonus -julia [real] [imaginary]\n");
		exit(1);
	}
...
int	main(int ac, char **av)
{
	...
	fractal.mlx.win = mlx_new_window(fractal.mlx.mlx, \
